                    ...
                    <div class="pull-left">
                        <address>
                            ...
                            <p class="text-muted m-l-5">
                                ...
                                Alamat <span style="margin-left:68px"> </span>: {{ $dataInvoice->user->alamat_cabang }}
                                <br />
                                No. Telp <span style="margin-left:63px"> </span>:
                                {{ $dataInvoice->user->no_telp == 0 ? '-' : $dataInvoice->user->no_telp }}
                        </address>
                    </div>
                    ...
                    <div class="pull-right m-t-10 text-right">
                        ...
                        <p>Disc @if ($item->disc == '')
                            ...
                            @endif : <input type="hidden"
                                value="{{ $disc = ($hitung * $item->disc) / 100 }}"> {{ Rupiah::getRupiah($disc) }}
                        </p>
                        <hr>
