            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-2 mb-md-0">
                    <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex py-75" id="pill-target" data-toggle="pill" href="#vertical-target"
                                aria-expanded="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link d-flex py-75" id="pill-notif" data-toggle="pill" href="#vertical-notif"
                                aria-expanded="false">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-md-4">
                                                ...
                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-start">
                                                    ...
                                                    <button type="reset"
                                                        class="btn btn-outline-warning">Batalkan</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="vertical-notif" role="tabpanel"
                                        aria-labelledby="pill-notif" aria-expanded="false">
                                        <div class="alert alert-danger">Baca Dokumentasi untuk mempermudah integrasi dan
                                            penggunaan Notifikasi pada halaman <a
                                                href="{{ url('dokumentasi') }}"><b>Dokumentasi.</b></a></div>
                                        <form action="{{ route('set-notif.update', Auth::id()) }}" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-1">
                                                    <div class="custom-control custom-switch custom-control-inline">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="email" {{ $setnotif->email == 1 ? 'checked' : '0' }}
                                                            value="1" id="email">
                                                ...
                                                <div class="col-12 mb-1">
                                                    <div class="custom-control custom-switch custom-control-inline">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="telegram_order_masuk"
                                                            {{ $setnotif->telegram_order_masuk == 1 ? 'checked' : '0' }}
                                                            value="1" id="telegram_order_masuk">
                                                        <label class="custom-control-label mr-1"
                                                            for="telegram_order_masuk"></label>
                                                        <span class="switch-label w-100">Aktifkan Jika Ingin Mendapatkan
                                                            Notifikasi Setiap Order Masuk</span>
                                                    </div>
                                                ...
                                                <div class="col-12 mb-1">
                                                    <div class="custom-control custom-switch custom-control-inline">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="telegram_order_selesai"
                                                            {{ $setnotif->telegram_order_selesai == 1 ? 'checked' : '0' }}
                                                            value="1" id="telegram_order_selesai">
                                                        <label class="custom-control-label mr-1"
                                                            for="telegram_order_selesai"></label>
                                                        <span class="switch-label w-100">Aktifkan Jika Ingin Mendapatkan
                                                            Notifikasi Setiap Order Selesai</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-1">
                                                    <div class="form-group">
                                                        <input type="text" name="telegram_channel_masuk"
                                                            class="form-control"
                                                            placeholder="Masukan Nama Channel Telegram"
                                                            value=" {{ $setnotif->telegram_channel_masuk }} ">
                                                        @if ($setnotif->telegram_order_selesai == 1 || $setnotif->telegram_order_masuk == 1)
                                                            @if ($setnotif->telegram_channel_masuk == '')
                                                                <small class="text-danger">Channel telegram wajib
                                                                    diisi.</small>
                                                            @endif
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="col-12 mb-1">
                                                    <div class="custom-control custom-switch custom-control-inline">
                                                        <input type="checkbox" class="custom-control-input"
                                                            name="wa_order_selesai"
                                                            {{ $setnotif->wa_order_selesai == 1 ? 'checked' : '0' }}
                                                            value="1" id="wa_order_selesai">
                                                        <label class="custom-control-label mr-1"
                                                            for="wa_order_selesai"></label>
                                                        <span class="switch-label w-100">Aktifkan Jika Ingin Mengirimkan
                                                            Notifikasi Setiap Order Selesai Kepada Customer</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 mb-1">
                                                    <div class="form-group">
                                                        <input type="text" name="wa_token" class="form-control"
                                                            placeholder="Masukan Token API"
                                                            value="{{ $setnotif->wa_token }}">
                                                        @if ($setnotif->wa_order_selesai == 1)
                                                            @if ($setnotif->wa_token == '')
                                                                <small class="text-danger">Token WhatsApp wajib
                                                                    diisi.</small>
                                                            @endif
                                                        @endif
                                                    </div>
