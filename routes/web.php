...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('/')->middleware('role:Admin')->group(function () {
        ...
        Route::delete('delete-harga', 'Admin\FinanceController@hargadelete');
    ...
    Route::prefix('/')->middleware('role:Karyawan')->group(function () {
        ...
        Route::get('broadcast', 'Karyawan\CustomerController@broadcast')->name('customers.broadcast'); // Broadcast WhatsApp
        Route::post('broadcast', 'Karyawan\CustomerController@sendBroadcast')->name('send.broadcast'); // Broadcast WhatsApp
