                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-1">
                            ...
                            <span>Instalasi & Penggunaan Aplikasi Laundry</span>
                            <hr>
                        </h4>
                        <p>
                        <h5>Requirements</h5>
                        ...
                        <ul>
                            ...
                            <li>Clone the repository: <code> git clone https://github.com/andes2912/laundry.git </code>
                            </li>
                        ...
                        <ul>
                            <li> Login sebagai Karyawan
                                <ul>
                                    <li>Untuk membuat akun karyawan silahkan pergi ke menu <b> Data User > Karyawan</b>
                                    </li>
