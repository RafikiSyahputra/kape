        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="message-text" class="control-label">Lama Pengerjaan:</label>
                        <input type="text" name="hari" id="hari" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="control-label">Berat Per Gram :</label>
                        <input type="text" name="kg" id="kg" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="control-label">Harga Per 1 Kg</label>
                        <input type="text" name="harga" id="harga" class="form-control">
                        <small class="form-control-feedback "> 1000 Gram = 1 Kilogram </small>
                    </div>
                </form>
            </div>
