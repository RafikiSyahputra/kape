            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-sm btn-danger" data-toggle="modal"
                                                    data-target="#hapus_harga" data-id="{{ $item->id }}"
                                                    id="click_harga_del">Hapus</a>
                                            </td>
                                        </tr>
                                        <?php $no++; ?>
                                    @endforeach
                        ...
                        @include('modul_admin.laundri.hapusharga')
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="card card-outline-info">
                    <div class="card-header">
                        ...
                        <span class="text-danger">1000 Gram = 1 Kg.</span>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-body">
                                @if ($karyawan == !null)
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group has-success">
                                                <label class="control-label">Jenis Pakaian / Cucian</label>
                                                <input type="text" name="jenis" value="{{ old('jenis') }}"
                                                    class="form-control @error('jenis') is-invalid @enderror"
                                                    placeholder="Tambahkan Jenis Pakaian / Cucian" autocomplete="off">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group has-success">
                                                <label class="control-label">Berat Per Gram</label>
                                                <input type="text" class="form-control form-control-danger"
                                                    value="1000 g" placeholder="Berat" readonly autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group has-success">
                                                <label class="control-label">Harga Per 1000 gram (1 KG) </label>
                                                <input type="text"
                                                    class="form-control form-control-danger @error('harga') is-invalid @enderror format_harga"
                                                    name="harga" value="{{ old('harga') }}"placeholder="Harga Per Gram"
                                                    autocomplete="off">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group has-success">
                                                ...
                                                <input type="text" name="hari" value="{{ old('hari') }}"
                                                    ...
                                                    placeholder="Lama Hari / Jam" autocomplete="off">
                                                @error('hari')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
...
@section('scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#click_harga', function() {
                var id = $(this).data('id');
                var jenis = $(this).data('id-jenis');
                var kg = $(this).data('id-kg');
                var harga = $(this).data('id-harga');
                var hari = $(this).data('id-hari');
                var status = $(this).data('id-status');

                // Mengisi nilai ke modal Edit
                $('#edit_harga #id_harga').val(id);
                $('#edit_harga #jenis').val(jenis);
                $('#edit_harga #kg').val(kg);
                $('#edit_harga #harga').val(harga);
                $('#edit_harga #hari').val(hari);
                $('#edit_harga #status').val(status);
            });

            // Ketika tombol Hapus diklik
            $(document).on('click', '#click_harga_del', function() {
                var id = $(this).data('id');

                // Mengisi nilai ke modal Hapus
                $('#hapus_harga #id_harga').val(id);
            });
        });
