...
@section('title', 'Admin - Data Keuangan')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 col-12 col-md-12">
                            ...
                            <small>Tercapai {{ $kgDay }} Kg <i
                                    class="feather icon-{{ $kgDay >= $target->target_day ? 'check-circle' : '' }}"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 col-12 col-md-12">
                            ...
                            <small>Tercapai {{ $kgMonth }} Kg <i
                                    class="feather icon-{{ $kgMonth >= $target->target_month ? 'check-circle' : '' }}"
                                    style="color: blue"></i></small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 col-12 col-md-12">
                            ...
                            <small>Tercapai {{ $kgYear }} Kg <i
                                    class="feather icon-{{ $kgYear >= $target->target_year ? 'check-circle' : '' }}"
                                    style="color: blue"></i></small>
                        </div>
                    </div>
                </div>
