                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <p class="card-text mb-2">Kata sandi baru Anda harus berbeda dari kata sandi yang
                                ...
                                <form class="auth-reset-password-form mt-2" action="{{ route('password.update') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="email"
                                                ...
                                                value=" {{ $email ?? old('email') }} " id="email" name="email" />
                                    ...
                                    <button type="submit" class="btn btn-primary btn-block">Buat Password
                                        Baru</button>
                                </form>
