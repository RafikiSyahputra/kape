                                ...
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">Halo Kak,
                                            </p>
                                            <p
                                            ...
                                            <p
                                                ...
                                                Terima kasih sudah mempercayakan pakaian kakak kepada kami, berikut ini
                                                adalah invoice untuk Laundry kakak. Untuk mengetahui status Laundry,
                                                kakak bisa mengecek nya melalui halaman Dashboard.
                                            </p>
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th colspan="4">
                                                                        Diskon
                                                                        {{ $data['disc'] == null || 0 ? '0' : $data['disc'] }}
                                                                        %
                                                                    </th>
                                                                    <td style="color:black">
                                                                        Rp.
                                                                        {{ number_format($data['harga_disc'], 0, ',', '.') }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan="4">Total Bayar</th>
                                                                    <td style="color:black; font-weight:bold">Rp.
                                                                        {{ number_format($data['harga_akhir'], 0, ',', '.') }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <ol>
                                                @foreach ($data['bank'] as $banks)
                                                    <li> {{ $banks->nama_bank }} <br> {{ $banks->no_rekening }} a/n
                                            ...
                                            <p
                                                style="font-size: 14px; line-height: 24px; margin-top: 6px; margin-bottom: 20px;">
                                                Jika kakak memiliki pertanyaan tentang invoice ini, cukup balas email
                                                ini atau hubungi tim dukungan kami untuk mendapatkan bantuan.
                                            </p>
                                            <p
                                                style="font-size: 14px; line-height: 24px; margin-top: 6px; margin-bottom: 20px;">
                                                Cheers,
