...
<head>
    ...
    <meta name="keywords" content="E-Laundry, Laundry77">
    <meta name="author" content="Rafiki Syahputra">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('home') }}">
                        ...
                        <h2 class="brand-text mb-0">Laundry77</h2>
                    </a></li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                        ...
                        <ul class="menu-content">
                            <li class="nav-item {{ request()->is('finance') ? 'active' : '' }}">
                                <a href="{{ route('finance.index') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Keuangan</span></a>
                            </li>
                ...
                @elseif(auth::user()->auth == 'Karyawan')
                        ...
                        <ul class="menu-content">
                            <li class="nav-item {{ request()->is('pelayanan') ? 'active' : '' }}">
                                <a href="{{ route('pelayanan.index') }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Data Order</span></a>
                            </li>
                            ...
                            <li class="nav-item {{ request()->is('broadcast') ? 'active' : '' }}">
                                <a href="{{ '/broadcast' }}"><i class="feather icon-circle"></i><span
                                        class="menu-item" data-i18n="List">Broadcast Customer</span></a>
                            </li>
                    ...
                    <li class="nav-item"><a href="{{ url('/') }}" target="_blank"><i
                                ...
                                data-i18n="Dashboard">Beranda</span></a>
                    </li>
