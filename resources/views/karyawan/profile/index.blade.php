                    ...
                    <form action=" {{ url('profile-karyawan/update', Auth::id()) }}" method="POST"
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-success">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="no_telp_raw" class="form-control" placeholder="81234567890"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group has-success">
                                        <label class="control-label">Nama Cabang Laundry</label>
                                        <input type="text" name="nama_cabang" class="form-control" readonly
                                ...
                                <div class="col-md-12">
                                    <div class="form-group has-success">
                                        <label class="control-label">Alamat Cabang Laundry</label>
