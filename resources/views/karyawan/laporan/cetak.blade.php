...
<body>
    <div class="container-fluid">
            ...
            <thead>
                ...
                <tr>
                    <td style="padding-bottom:80px" colspan="2">
                        <h3> &nbsp;<b class="text-danger">Cabang: {{ $data->user->nama_cabang }}</b></h3>
            ...
            <tbody>
                ...
                @foreach ($invoice as $item)
                    <tr>
                        ...
                        <td style="color:black">{{ $item->price->jenis ?? 'Jenis Tidak Tersedia'}}</td>
        ...
        <h5 style="text-align: right;">Terima Kasih Sudah Mempercayai Cucian Kamu Kepada Kami!</h5>
        <h3 style="text-align: right;">Laundry77</h3>
    </div>
</body>
