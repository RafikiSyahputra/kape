...
<table class="table table-hover table-bordered">
    <thead>
        <tr>
            <th colspan="{{ $total_colspan }}" style="text-align: center;"><b>LAPORAN TRANSAKSI LAUNDRY77</b></th>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        @foreach ($data as $key => $items)
            <tr>
                ...
                <td colspan="2"> {{ $items->price->jenis ?? 'Jenis Tidak Tersedia' }}</td>
                <td colspan="2">
                    @if ($items->status_payment == 'Success')
