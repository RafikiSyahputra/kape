                                            ...
                                            <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;"
                                                ...
                                                <div
                                                    ...
                                                    <h2
                                                        ...
                                                        Halo,Kak {{ $data['customer'] }}.</h2>
                                                    <p>Kami ingin memberitahu bahwa Laundry kakak dengan nomor invoice
                                                        <span
                                                            style="font-weight: bold; color:black">{{ $data['invoice'] }}</span>
                                                        sudah selesai dan sudah bisa diambil.</p>
                                                    <p
