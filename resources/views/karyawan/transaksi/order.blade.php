...
@section('title', 'Karyawan - Orderan')
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Order Masuk /
                <a href="{{ url('add-order') }}" class="btn btn-primary">Tambah Orderan Baru</a>
            </h4>
                    ...
                    <tbody>
                        ...
                        @foreach ($order as $item)
                            <tr>
                                ...
                                <td>{{ $item->customer ?? 'Customer Tidak Tersedia'}}</td>
                                <td>
